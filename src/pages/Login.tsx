      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-xl overflow-hidden border border-slate-100">
        ...
        <div className="p-8">
          ...
          <div className="mt-8 text-center text-xs text-slate-400 border-t pt-6 border-slate-100">
             <p className="font-semibold text-slate-500 mb-2">Demo Credentials</p>
            <p>Admin: <span className="font-mono bg-slate-100 px-1 rounded text-slate-600">admin@alphabeta.org</span> / <span className="font-mono bg-slate-100 px-1 rounded text-slate-600">admin1963</span></p>
            <p className="mt-1">Guest: <span className="font-mono bg-slate-100 px-1 rounded text-slate-600">guest@alphabeta.org</span> / <span className="font-mono bg-slate-100 px-1 rounded text-slate-600">guest1925</span></p>
          </div>
        </div>
      </div>
    </div>
