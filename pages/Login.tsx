      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-xl overflow-hidden border border-slate-100">
        ...
        <div className="p-8">
          ...
          <div className="mt-8 text-center text-xs text-slate-400 border-t pt-6 border-slate-100">
            ...
            <p>Admin: <span className="font-mono bg-slate-100 px-1 rounded text-slate-600">Developed By:</span> / <span className="font-mono bg-slate-100 px-1 rounded text-slate-600">TAMZ 0102-11-47809</span></p>
            <p className="mt-1">Guest: <span className="font-mono bg-slate-100 px-1 rounded text-slate-600">ALPHA PHI OMEGA</span> / <span className="font-mono bg-slate-100 px-1 rounded text-slate-600"> Philippines Incorporated</span></p>
          </div>
        </div>
      </div>
    </div>
